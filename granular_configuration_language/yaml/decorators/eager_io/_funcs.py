...
eager_io_text_loader_interpolates = interpolate_value_without_ref(eager_io_text_loader)
...
eager_io_binary_loader_interpolates = interpolate_value_without_ref(eager_io_text_loader)
